...
TO_STATION = '重庆'
# 乘车日期（格式: YYYY-mm-dd）
TRAIN_DATE = ['2020-04-09','2020-05-02']
# 购票人身份证号
PASSENGERS_ID = ['******']
# 票类型（单程:dc 往返:wc）
TOUR_FLAG = 'dc'
...
ACCOUNT_SID = "ACfd9ea8ebc46f4219421769b96665a1de"
# Your Auth Token from twilio.com/console
AUTO_TOKEN = "2881e0423819964865927fdcd4708a58"
FROM_NUM = '12058574827'
TO_NUM = '+******'
#儿子
# TO_NUM = '+******'
